...
const MANAGER_READ = [...APPROVAL_MANAGERS, ...SENIOR_READ];
...
export const NAV: NavEntry[] = [
  ...
  { path: "/recipes", label: "Recipes", icon: ChefHat,
    roles: ["chef", "head_chef", ...APPROVAL_MANAGERS, ...ADMIN_UP], hideFrom: OWNER_AND_ADMIN },
  // The Head Supervisor's morning menu/data-entry job.
  { path: "/menu-scan", label: "Daily Menu", icon: ScanLine,
    roles: ["head_supervisor", ...APPROVAL_MANAGERS, ...ADMIN_UP], hideFrom: OWNER_AND_ADMIN },
  ...
  // Masters and money.
  { path: "/vendors", label: "Vendor Master", icon: Store, roles: ["store_keeper", ...MANAGER_READ] },
  ...
  { path: "/reports-center", label: "Reports", icon: BarChart3,
    roles: ["head_chef", ...MANAGER_READ] },
